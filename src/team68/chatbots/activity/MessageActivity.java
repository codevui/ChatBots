...
public class MessageActivity extends RobotActivity implements SpeakToTextListener,OnRobotEventListener  {
...
//			}
	...
	public void onRobotEvent(String arg0, RobotValue arg1) {
		makeToast(arg0);
		if (arg0 == RobotEvent.MIDDLE_TACTIL_TOUCHED) {
			makeToast("The Head Was Touched");
		}
